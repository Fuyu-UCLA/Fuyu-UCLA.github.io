...
* {% block header %}{% endblock %} means that the header of other pages extending this page will come here.
* {% block content %}{% end block %} means that the content of other pages extending this page will come here.
